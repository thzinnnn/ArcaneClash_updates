...
const UPDATE_HISTORY=[
  {version:'0.9.1',date:'22 AGO 2026',title:'Expansão do Arsenal',tag:'ATUAL',tone:'#ffbd66',notes:['98 cartas novas elevaram o catálogo de 74 para 172.','Cada classe agora possui 20 exclusivas e compartilha 12 Neutras: 32 opções legais por classe.','Raridade agora aparece com moldura, cor, símbolo e nome em cada carta.','Sinalização integrada à Forja, mão, mulligan, Baús, campo, Inspector e modos online.','Novas cartas funcionam em decks, Baús, Espólios, Relíquias e modos online.']},
