...
function renderUpdateHistory(){
  ...
  modalShell('Histórico de Updates','A JORNADA ATÉ A VERSÃO 1.0',`<p class="arcModalLead">Aqui ficam registradas as mudanças reais de cada versão pública. A versão 1.0 consolida o roadmap iniciado no Lobby Arcano e preserva todo o progresso das versões anteriores.</p><div class="arcUpdateTimeline">${entries}</div><div class="arcUpdateFuture"><span>MARCO CONCLUÍDO</span><b>1.0.0 · Convergência</b><small>Combate, coleção, Maestria, social, eventos, administração e segurança reunidos no lançamento definitivo.</small></div>`);
}
