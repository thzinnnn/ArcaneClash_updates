...
const UPDATE_HISTORY=[
  {version:'1.3.1',date:'01 SET 2026',title:'Campo Refeito',tag:'INTERFACE',tone:'#63e3fa',notes:['Doutrina, Conquista e condição de vitória foram reunidas em uma faixa própria entre o placar e o campo.','O antigo painel flutuante deixou de cobrir o topo das rotas e de aparecer solto fora da área do jogo.','Objetivos agora fazem parte do cabeçalho de cada rota, preservando o nome do local e o espaço das criaturas.','As três rotas receberam mais contraste, profundidade, bordas e cores próprias.','O novo campo foi recalibrado em desktop, notebook e celular sem rolagem horizontal.']},
  {version:'1.3.0',date:'01 SET 2026',title:'Reforja',tag:'COMBATE',tone:'#c588ff',notes:['As três rotas recebem objetivos diferentes em cada partida: Bastião, Poço de Mana, Terreno de Caça, Santuário, Fenda Arcana ou Forja de Guerra.','Controlar o objetivo ativo concede efeitos reais, como cura, mana, compra de carta ou fortalecimento das criaturas.','A nova Conquista Territorial permite vencer mantendo vantagem em duas das três rotas por rodadas consecutivas.','Fusão Arcana permite selecionar duas criaturas do deck e criar uma carta lendária funcional que aparece nas batalhas.','Doutrinas de classe concedem bônus próprios quando o deck mantém alta fidelidade à identidade da classe.','Interface de combate exibe objetivos, controlador de cada rota, progresso de Conquista, doutrina e Fusão equipada.']},
  {version:'1.2.1',date:'24 AGO 2026',title:'Mapa Vivo',tag:'INTERFACE',tone:'#65dcf5',notes:['A campanha ganhou um mapa-múndi ilustrado, com os 24 destinos posicionados diretamente sobre estradas, fortalezas, florestas e ruínas.','Rotas liberadas brilham no cenário; encontros concluídos, chefes e destinos bloqueados possuem estados visuais próprios.','O mapa pode ser explorado horizontalmente no celular sem reduzir os destinos a botões minúsculos.','O lobby agora exibe apenas quatro acessos principais: Guerra dos Reinos, Meus Decks, Coleção e Centro Arcano.','Recursos secundários foram organizados por categoria dentro do Centro Arcano, reduzindo a poluição visual sem remover funções.']},
  {version:'1.2.0',date:'24 AGO 2026',title:'Guerra dos Reinos',tag:'EXPANSÃO',tone:'#ff9c68',notes:['A campanha foi reconstruída com 24 encontros distribuídos entre Aurora, Coroa Verde, Trono Boreal e Império do Vazio.','Cada batalha possui comandante, arquétipo de IA, deck inimigo exclusivo e modificador ambiental próprio.','Os quatro chefes agora possuem vida especial, três fases e mudanças reais de poder durante o combate.','Escolhas liberam rotas diferentes, lojas oferecem relíquias e santuários permitem recuperar Fôlego ou preparar bênçãos.','Cofre de Decks adiciona cinco espaços por classe, nomes editáveis, histórico de partidas e taxa de vitória.','Códice da Guerra inclui 30 níveis, trilha de recompensas e conquistas; o Bestiário registra comandantes e chefes encontrados.','Interface de batalha identifica o inimigo, estilo tático, efeito do campo e transições de fase sem cobrir a mão.']},
...
function showNews(){
  ...
  requestAnimationFrame(()=>{
    ...
    if(title)title.textContent='Convergência 1.0';
    if(rules)rules.innerHTML='<p><b>♟ Estratégia completa:</b> deck construído, mulligan, Reserva conhecida, objetivos de rota e vitória alternativa por Domínio.</p><p><b>💎 Coleção & Crafting:</b> cópias agora têm função real; crie, desmonte, favorite e use até três iguais para aumentar a consistência.</p><p><b>✥ Maestria:</b> as oito classes ganharam árvores próprias com progressão permanente para PvE.</p><p><b>⏳ Controle da partida:</b> desfazer antes de encerrar, confirmação de fim perigoso, últimas ações e replays locais.</p><p><b>🌌 Mundo vivo:</b> eventos semanais, temporada, missões, conquistas e recompensas de coleção.</p><p><b>🛡️ Administração real:</b> jogadores online, IDs, espectador, banimentos, economia e auditoria protegidos por MFA.</p><p><b>📱 Definitiva na Web:</b> migração automática, cloud save, cache offline e interface responsiva para PC e celular.</p>';
  });
}
